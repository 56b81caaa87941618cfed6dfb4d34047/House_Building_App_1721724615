...
*/
Vue.component("simple_footer_component_1721724617", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            HomeBuilder - Construct Your Dream
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        HomeBuilder empowers you to design and plan your ideal living space. Our user-friendly tools help bring your vision to life, from sketching floor plans to visualizing the finished product. Start building the home of your dreams today.
                    </div>
                </div>
            </div>
        </footer> 
